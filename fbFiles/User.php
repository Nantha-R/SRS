    ...
    function checkUser($userData = array()){
        if(!empty($userData)){
            ...
            if($prevResult->num_rows > 0){
                ...
                // Insert user data
                $query = "INSERT INTO ".$this->userTbl." SET oauth_uid = '".$userData['oauth_uid']."', first_name = '".$userData['first_name']."', last_name = '".$userData['last_name']."', email = '".$userData['email']."', gender = '".$userData['gender']."', locale = '".$userData['locale']."', picture = '".$userData['picture']."', link = '".$userData['link']."'";
